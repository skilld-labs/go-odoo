...
func (c *Client) FindAccountInvoiceRefund(criteria *Criteria) (*AccountInvoiceRefund, error) {
	...
	return nil, fmt.Errorf("no account.invoice.refund was found with criteria %v", criteria)
}
...
func (c *Client) FindAccountInvoiceRefundId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no account.invoice.refund was found with criteria %v and options %v", criteria, options)
}
