...
func (svc *MailTestService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.MailTestModel, name)
}

func (svc *MailTestService) GetByIds(ids []int64) (*types.MailTests, error) {
	m := &types.MailTests{}
...
func (svc *MailTestService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.MailTestModel, fields, relations)
}

func (svc *MailTestService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.MailTestModel, ids, fields, relations)
}

func (svc *MailTestService) Delete(ids []int64) error {
