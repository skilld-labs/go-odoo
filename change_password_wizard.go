...
func (c *Client) FindChangePasswordWizard(criteria *Criteria) (*ChangePasswordWizard, error) {
	...
	return nil, fmt.Errorf("no change.password.wizard was found with criteria %v", criteria)
}
...
func (c *Client) FindChangePasswordWizardId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no change.password.wizard was found with criteria %v and options %v", criteria, options)
}
