...
func (svc *BaseImportTestsModelsM2oRelatedService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.BaseImportTestsModelsM2oRelatedModel, name)
}

func (svc *BaseImportTestsModelsM2oRelatedService) GetByIds(ids []int) (*types.BaseImportTestsModelsM2oRelateds, error) {
...
func (svc *BaseImportTestsModelsM2oRelatedService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.BaseImportTestsModelsM2oRelatedModel, fields, relations)
}

func (svc *BaseImportTestsModelsM2oRelatedService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.BaseImportTestsModelsM2oRelatedModel, ids, fields, relations)
}

func (svc *BaseImportTestsModelsM2oRelatedService) Delete(ids []int) error {
