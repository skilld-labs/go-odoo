...
func (c *Client) FindProductPricelist(criteria *Criteria) (*ProductPricelist, error) {
	...
	return nil, fmt.Errorf("no product.pricelist was found with criteria %v", criteria)
}
...
func (c *Client) FindProductPricelistId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no product.pricelist was found with criteria %v and options %v", criteria, options)
}
