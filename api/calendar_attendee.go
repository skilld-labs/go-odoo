...
func (svc *CalendarAttendeeService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.CalendarAttendeeModel, name)
}

func (svc *CalendarAttendeeService) GetByIds(ids []int) (*types.CalendarAttendees, error) {
...
func (svc *CalendarAttendeeService) GetByField(field string, value string) (*types.CalendarAttendees, error) {
	c := &types.CalendarAttendees{}
	return c, svc.client.getByName(types.CalendarAttendeeModel, field, value, c)
}
...
func (svc *CalendarAttendeeService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.CalendarAttendeeModel, fields, relations)
}

func (svc *CalendarAttendeeService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.CalendarAttendeeModel, ids, fields, relations)
}

func (svc *CalendarAttendeeService) Delete(ids []int) error {
