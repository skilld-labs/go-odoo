...
func (svc *ResUsersService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.ResUsersModel, name)
}

func (svc *ResUsersService) GetByIds(ids []int64) (*types.ResUserss, error) {
	r := &types.ResUserss{}
...
func (svc *ResUsersService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.ResUsersModel, fields, relations)
}

func (svc *ResUsersService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.ResUsersModel, ids, fields, relations)
}

func (svc *ResUsersService) Delete(ids []int64) error {
