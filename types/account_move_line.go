...
type AccountMoveLine struct {
	...
	IsUnaffectedEarningsLine bool      `xmlrpc:"is_unaffected_earnings_line"`
	...
	ParentState              string    `xmlrpc:"parent_state"`
	...
	TaxBaseAmount            float64   `xmlrpc:"tax_base_amount"`
...
type AccountMoveLineNil struct {
	...
	ParentState              interface{} `xmlrpc:"parent_state"`
	...
	TaxBaseAmount            interface{} `xmlrpc:"tax_base_amount"`
	TaxExigible              bool        `xmlrpc:"tax_exigible"`
