...
type MailComposeMessage struct {
	...
	NotifiedBccContainsShare *Bool      `xmlrpc:"notified_bcc_contains_share,omitempty"`
	NotifyAuthor             *Bool      `xmlrpc:"notify_author,omitempty"`
	NotifyAuthorMention      *Bool      `xmlrpc:"notify_author_mention,omitempty"`
	NotifySkipFollowers      *Bool      `xmlrpc:"notify_skip_followers,omitempty"`
	ParentId                 *Many2One  `xmlrpc:"parent_id,omitempty"`
	PartnerIds               *Relation  `xmlrpc:"partner_ids,omitempty"`
	PartnerIdsAllHaveEmail   *Bool      `xmlrpc:"partner_ids_all_have_email,omitempty"`
