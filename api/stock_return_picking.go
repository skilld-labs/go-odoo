...
func (svc *StockReturnPickingService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.StockReturnPickingModel, name)
}

func (svc *StockReturnPickingService) GetByIds(ids []int) (*types.StockReturnPickings, error) {
...
func (svc *StockReturnPickingService) GetByField(field string, value string) (*types.StockReturnPickings, error) {
	s := &types.StockReturnPickings{}
	return s, svc.client.getByName(types.StockReturnPickingModel, field, value, s)
}
...
func (svc *StockReturnPickingService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.StockReturnPickingModel, fields, relations)
}

func (svc *StockReturnPickingService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.StockReturnPickingModel, ids, fields, relations)
}

func (svc *StockReturnPickingService) Delete(ids []int) error {
