...
func (svc *AccountInvoiceReportService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.AccountInvoiceReportModel, name)
}

func (svc *AccountInvoiceReportService) GetByIds(ids []int64) (*types.AccountInvoiceReports, error) {
...
func (svc *AccountInvoiceReportService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.AccountInvoiceReportModel, fields, relations)
}

func (svc *AccountInvoiceReportService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.AccountInvoiceReportModel, ids, fields, relations)
}

func (svc *AccountInvoiceReportService) Delete(ids []int64) error {
