...
func (svc *IrQwebFieldQwebService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.IrQwebFieldQwebModel, name)
}

func (svc *IrQwebFieldQwebService) GetByIds(ids []int) (*types.IrQwebFieldQwebs, error) {
...
func (svc *IrQwebFieldQwebService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.IrQwebFieldQwebModel, fields, relations)
}

func (svc *IrQwebFieldQwebService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.IrQwebFieldQwebModel, ids, fields, relations)
}

func (svc *IrQwebFieldQwebService) Delete(ids []int) error {
