...
type AccountJournal struct {
	...
	HasInvalidStatements                 *Bool       `xmlrpc:"has_invalid_statements,omitempty"`
	...
	IncomingEinvoiceNotificationEmail    *String     `xmlrpc:"incoming_einvoice_notification_email,omitempty"`
	...
	IsSelfBilling                        *Bool       `xmlrpc:"is_self_billing,omitempty"`
	...
	NonDeductibleAccountId               *Many2One   `xmlrpc:"non_deductible_account_id,omitempty"`
	...
	ShowFetchInEinvoicesButton           *Bool       `xmlrpc:"show_fetch_in_einvoices_button,omitempty"`
	ShowOnDashboard                      *Bool       `xmlrpc:"show_on_dashboard,omitempty"`
	ShowRefreshOutEinvoicesStatusButton  *Bool       `xmlrpc:"show_refresh_out_einvoices_status_button,omitempty"`
