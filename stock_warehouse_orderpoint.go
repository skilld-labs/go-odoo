...
type StockWarehouseOrderpoint struct {
	...
	AvailableVendor               *Many2One  `xmlrpc:"available_vendor,omitempty"`
	CompanyId                     *Many2One  `xmlrpc:"company_id,omitempty"`
	CreateDate                    *Time      `xmlrpc:"create_date,omitempty"`
	CreateUid                     *Many2One  `xmlrpc:"create_uid,omitempty"`
	DaysToOrder                   *Float     `xmlrpc:"days_to_order,omitempty"`
	DeadlineDate                  *Time      `xmlrpc:"deadline_date,omitempty"`
	DisplayName                   *String    `xmlrpc:"display_name,omitempty"`
	EffectiveRouteId              *Many2One  `xmlrpc:"effective_route_id,omitempty"`
	EffectiveVendorId             *Many2One  `xmlrpc:"effective_vendor_id,omitempty"`
	Id                            *Int       `xmlrpc:"id,omitempty"`
	LeadDays                      *Float     `xmlrpc:"lead_days,omitempty"`
	LeadHorizonDate               *Time      `xmlrpc:"lead_horizon_date,omitempty"`
