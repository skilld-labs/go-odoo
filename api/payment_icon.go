...
func (svc *PaymentIconService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.PaymentIconModel, name)
}

func (svc *PaymentIconService) GetByIds(ids []int) (*types.PaymentIcons, error) {
...
func (svc *PaymentIconService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.PaymentIconModel, fields, relations)
}

func (svc *PaymentIconService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.PaymentIconModel, ids, fields, relations)
}

func (svc *PaymentIconService) Delete(ids []int) error {
