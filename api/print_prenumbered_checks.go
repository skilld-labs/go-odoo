...
func (svc *PrintPrenumberedChecksService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.PrintPrenumberedChecksModel, name)
}

func (svc *PrintPrenumberedChecksService) GetByIds(ids []int) (*types.PrintPrenumberedCheckss, error) {
...
func (svc *PrintPrenumberedChecksService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.PrintPrenumberedChecksModel, fields, relations)
}

func (svc *PrintPrenumberedChecksService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.PrintPrenumberedChecksModel, ids, fields, relations)
}

func (svc *PrintPrenumberedChecksService) Delete(ids []int) error {
