...
func (svc *AccountOpeningService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.AccountOpeningModel, name)
}

func (svc *AccountOpeningService) GetByIds(ids []int) (*types.AccountOpenings, error) {
...
func (svc *AccountOpeningService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.AccountOpeningModel, fields, relations)
}

func (svc *AccountOpeningService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.AccountOpeningModel, ids, fields, relations)
}

func (svc *AccountOpeningService) Delete(ids []int) error {
