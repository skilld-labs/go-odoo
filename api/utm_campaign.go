...
func (svc *UtmCampaignService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.UtmCampaignModel, name)
}

func (svc *UtmCampaignService) GetByIds(ids []int) (*types.UtmCampaigns, error) {
...
func (svc *UtmCampaignService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.UtmCampaignModel, fields, relations)
}

func (svc *UtmCampaignService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.UtmCampaignModel, ids, fields, relations)
}

func (svc *UtmCampaignService) Delete(ids []int) error {
