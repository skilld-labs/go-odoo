...
func (svc *IrActionsClientService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.IrActionsClientModel, name)
}

func (svc *IrActionsClientService) GetByIds(ids []int) (*types.IrActionsClients, error) {
...
func (svc *IrActionsClientService) GetByField(field string, value string) (*types.IrActionsClients, error) {
	i := &types.IrActionsClients{}
	return i, svc.client.getByName(types.IrActionsClientModel, field, value, i)
}
...
func (svc *IrActionsClientService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.IrActionsClientModel, fields, relations)
}

func (svc *IrActionsClientService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.IrActionsClientModel, ids, fields, relations)
}

func (svc *IrActionsClientService) Delete(ids []int) error {
