...
type AccountTax struct {
	...
	DisplayAlternativeTaxesField  *Bool      `xmlrpc:"display_alternative_taxes_field,omitempty"`
	...
	OriginalTaxIds                *Relation  `xmlrpc:"original_tax_ids,omitempty"`
	...
	ReplacingTaxIds               *Relation  `xmlrpc:"replacing_tax_ids,omitempty"`
	Sequence                      *Int       `xmlrpc:"sequence,omitempty"`
	TaxExigibility                *Selection `xmlrpc:"tax_exigibility,omitempty"`
	TaxGroupId                    *Many2One  `xmlrpc:"tax_group_id,omitempty"`
	TaxLabel                      *String    `xmlrpc:"tax_label,omitempty"`
	TaxScope                      *Selection `xmlrpc:"tax_scope,omitempty"`
	TypeTaxUse                    *Selection `xmlrpc:"type_tax_use,omitempty"`
	UblCiiRequiresExemptionReason *Bool      `xmlrpc:"ubl_cii_requires_exemption_reason,omitempty"`
	UblCiiTaxCategoryCode         *Selection `xmlrpc:"ubl_cii_tax_category_code,omitempty"`
	UblCiiTaxExemptionReasonCode  *Selection `xmlrpc:"ubl_cii_tax_exemption_reason_code,omitempty"`
