...
func (svc *ProjectTaskTypeService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.ProjectTaskTypeModel, name)
}

func (svc *ProjectTaskTypeService) GetByIds(ids []int64) (*types.ProjectTaskTypes, error) {
...
func (svc *ProjectTaskTypeService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.ProjectTaskTypeModel, fields, relations)
}

func (svc *ProjectTaskTypeService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.ProjectTaskTypeModel, ids, fields, relations)
}

func (svc *ProjectTaskTypeService) Delete(ids []int64) error {
