...
func (svc *IrDefaultService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.IrDefaultModel, name)
}

func (svc *IrDefaultService) GetByIds(ids []int64) (*types.IrDefaults, error) {
	i := &types.IrDefaults{}
...
func (svc *IrDefaultService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.IrDefaultModel, fields, relations)
}

func (svc *IrDefaultService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.IrDefaultModel, ids, fields, relations)
}

func (svc *IrDefaultService) Delete(ids []int64) error {
