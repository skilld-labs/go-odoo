...
func (svc *StockChangeStandardPriceService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.StockChangeStandardPriceModel, name)
}

func (svc *StockChangeStandardPriceService) GetByIds(ids []int) (*types.StockChangeStandardPrices, error) {
...
func (svc *StockChangeStandardPriceService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.StockChangeStandardPriceModel, fields, relations)
}

func (svc *StockChangeStandardPriceService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.StockChangeStandardPriceModel, ids, fields, relations)
}

func (svc *StockChangeStandardPriceService) Delete(ids []int) error {
