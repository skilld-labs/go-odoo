...
func (svc *WorkflowService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.WorkflowModel, name)
}

func (svc *WorkflowService) GetByIds(ids []int64) (*types.Workflows, error) {
	w := &types.Workflows{}
...
func (svc *WorkflowService) GetByField(field string, value string) (*types.Workflows, error) {
	w := &types.Workflows{}
	return w, svc.client.getByField(types.WorkflowModel, field, value, w)
}
...
func (svc *WorkflowService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.WorkflowModel, fields, relations)
}

func (svc *WorkflowService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.WorkflowModel, ids, fields, relations)
}

func (svc *WorkflowService) Delete(ids []int64) error {
