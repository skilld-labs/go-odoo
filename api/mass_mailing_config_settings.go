...
func (svc *MassMailingConfigSettingsService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.MassMailingConfigSettingsModel, name)
}

func (svc *MassMailingConfigSettingsService) GetByIds(ids []int) (*types.MassMailingConfigSettingss, error) {
...
func (svc *MassMailingConfigSettingsService) GetByField(field string, value string) (*types.MassMailingConfigSettingss, error) {
	m := &types.MassMailingConfigSettingss{}
	return m, svc.client.getByName(types.MassMailingConfigSettingsModel, field, value, m)
}
...
func (svc *MassMailingConfigSettingsService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.MassMailingConfigSettingsModel, fields, relations)
}

func (svc *MassMailingConfigSettingsService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.MassMailingConfigSettingsModel, ids, fields, relations)
}

func (svc *MassMailingConfigSettingsService) Delete(ids []int) error {
