...
func (svc *SaleConfigSettingsService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.SaleConfigSettingsModel, name)
}

func (svc *SaleConfigSettingsService) GetByIds(ids []int64) (*types.SaleConfigSettingss, error) {
...
func (svc *SaleConfigSettingsService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.SaleConfigSettingsModel, fields, relations)
}

func (svc *SaleConfigSettingsService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.SaleConfigSettingsModel, ids, fields, relations)
}

func (svc *SaleConfigSettingsService) Delete(ids []int64) error {
