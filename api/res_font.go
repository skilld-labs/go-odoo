...
func (svc *ResFontService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.ResFontModel, name)
}

func (svc *ResFontService) GetByIds(ids []int64) (*types.ResFonts, error) {
	r := &types.ResFonts{}
...
func (svc *ResFontService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.ResFontModel, fields, relations)
}

func (svc *ResFontService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.ResFontModel, ids, fields, relations)
}

func (svc *ResFontService) Delete(ids []int64) error {
