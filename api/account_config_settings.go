...
func (svc *AccountConfigSettingsService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.AccountConfigSettingsModel, name)
}

func (svc *AccountConfigSettingsService) GetByIds(ids []int) (*types.AccountConfigSettingss, error) {
...
func (svc *AccountConfigSettingsService) GetByField(field string, value string) (*types.AccountConfigSettingss, error) {
	a := &types.AccountConfigSettingss{}
	return a, svc.client.getByName(types.AccountConfigSettingsModel, field, value, a)
}
...
func (svc *AccountConfigSettingsService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.AccountConfigSettingsModel, fields, relations)
}

func (svc *AccountConfigSettingsService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.AccountConfigSettingsModel, ids, fields, relations)
}

func (svc *AccountConfigSettingsService) Delete(ids []int) error {
