...
func (svc *MailFollowersService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.MailFollowersModel, name)
}

func (svc *MailFollowersService) GetByIds(ids []int) (*types.MailFollowerss, error) {
...
func (svc *MailFollowersService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.MailFollowersModel, fields, relations)
}

func (svc *MailFollowersService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.MailFollowersModel, ids, fields, relations)
}

func (svc *MailFollowersService) Delete(ids []int) error {
