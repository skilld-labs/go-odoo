...
func (c *Client) FindReportAccountReportFinancial(criteria *Criteria) (*ReportAccountReportFinancial, error) {
	...
	return nil, fmt.Errorf("no report.account.report_financial was found with criteria %v", criteria)
}
...
func (c *Client) FindReportAccountReportFinancialId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no report.account.report_financial was found with criteria %v and options %v", criteria, options)
}
