...
func (c *Client) FindImLivechatReportOperator(criteria *Criteria) (*ImLivechatReportOperator, error) {
	...
	return nil, fmt.Errorf("no im_livechat.report.operator was found with criteria %v", criteria)
}
...
func (c *Client) FindImLivechatReportOperatorId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no im_livechat.report.operator was found with criteria %v and options %v", criteria, options)
}
