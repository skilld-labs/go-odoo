...
func (svc *MailMassMailingService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.MailMassMailingModel, name)
}

func (svc *MailMassMailingService) GetByIds(ids []int) (*types.MailMassMailings, error) {
...
func (svc *MailMassMailingService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.MailMassMailingModel, fields, relations)
}

func (svc *MailMassMailingService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.MailMassMailingModel, ids, fields, relations)
}

func (svc *MailMassMailingService) Delete(ids []int) error {
