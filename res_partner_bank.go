...
type ResPartnerBank struct {
	...
	BankCity                         *String    `xmlrpc:"bank_city,omitempty"`
	BankCountry                      *Many2One  `xmlrpc:"bank_country,omitempty"`
	BankEmail                        *String    `xmlrpc:"bank_email,omitempty"`
	BankId                           *Many2One  `xmlrpc:"bank_id,omitempty"`
	BankName                         *String    `xmlrpc:"bank_name,omitempty"`
	BankPhone                        *String    `xmlrpc:"bank_phone,omitempty"`
	BankState                        *Many2One  `xmlrpc:"bank_state,omitempty"`
	BankStreet                       *String    `xmlrpc:"bank_street,omitempty"`
	BankStreet2                      *String    `xmlrpc:"bank_street2,omitempty"`
	BankZip                          *String    `xmlrpc:"bank_zip,omitempty"`
	...
	EmployeeHasMultipleBankAccounts  *Bool      `xmlrpc:"employee_has_multiple_bank_accounts,omitempty"`
	EmployeeId                       *Relation  `xmlrpc:"employee_id,omitempty"`
	EmployeeSalaryAmount             *Float     `xmlrpc:"employee_salary_amount,omitempty"`
	EmployeeSalaryAmountIsPercentage *Bool      `xmlrpc:"employee_salary_amount_is_percentage,omitempty"`
