...
type ProductProduct struct {
	...
	AttributeValueIds                      []int64   `xmlrpc:"attribute_value_ids"`
	...
	ImageVariant                           string    `xmlrpc:"image_variant"`
	...
	OrderpointIds                          []int64   `xmlrpc:"orderpoint_ids"`
	...
	PricelistItemIds                       []int64   `xmlrpc:"pricelist_item_ids"`
	...
	ReceptionCount                         int64     `xmlrpc:"reception_count"`
	...
	StockMoveIds                           []int64   `xmlrpc:"stock_move_ids"`
	StockQuantIds                          []int64   `xmlrpc:"stock_quant_ids"`
...
type ProductProductNil struct {
	LastUpdate                             interface{} `xmlrpc:"__last_update"`
	Active                                 bool        `xmlrpc:"active"`
	AttributeLineIds                       interface{} `xmlrpc:"attribute_line_ids"`
	AttributeValueIds                      interface{} `xmlrpc:"attribute_value_ids"`
	...
	ImageVariant                           interface{} `xmlrpc:"image_variant"`
	...
	OrderpointIds                          interface{} `xmlrpc:"orderpoint_ids"`
	...
	PricelistItemIds                       interface{} `xmlrpc:"pricelist_item_ids"`
	...
	ReceptionCount                         interface{} `xmlrpc:"reception_count"`
	Rental                                 bool        `xmlrpc:"rental"`
	...
	StockMoveIds                           interface{} `xmlrpc:"stock_move_ids"`
	StockQuantIds                          interface{} `xmlrpc:"stock_quant_ids"`
...
var ProductProductModel string = "product.product"

type ProductProducts []ProductProduct

type ProductProductsNil []ProductProductNil

func (s *ProductProduct) NilableType_() interface{} {
	return &ProductProductNil{}
}

func (ns *ProductProductNil) Type_() interface{} {
	s := &ProductProduct{}
	return load(ns, s)
}

func (s *ProductProducts) NilableType_() interface{} {
	return &ProductProductsNil{}
}

func (ns *ProductProductsNil) Type_() interface{} {
	s := &ProductProducts{}
	for _, nsi := range *ns {
		*s = append(*s, *nsi.Type_().(*ProductProduct))
	}
	return s
}
