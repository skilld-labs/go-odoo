...
func (c *Client) FindIrActionsActWindowView(criteria *Criteria) (*IrActionsActWindowView, error) {
	...
	return nil, fmt.Errorf("no ir.actions.act_window.view was found with criteria %v", criteria)
}
...
func (c *Client) FindIrActionsActWindowViewId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no ir.actions.act_window.view was found with criteria %v and options %v", criteria, options)
}
