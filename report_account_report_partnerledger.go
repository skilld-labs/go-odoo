...
func (c *Client) FindReportAccountReportPartnerledger(criteria *Criteria) (*ReportAccountReportPartnerledger, error) {
	...
	return nil, fmt.Errorf("no report.account.report_partnerledger was found with criteria %v", criteria)
}
...
func (c *Client) FindReportAccountReportPartnerledgerId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no report.account.report_partnerledger was found with criteria %v and options %v", criteria, options)
}
