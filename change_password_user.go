...
func (c *Client) FindChangePasswordUser(criteria *Criteria) (*ChangePasswordUser, error) {
	...
	return nil, fmt.Errorf("no change.password.user was found with criteria %v", criteria)
}
...
func (c *Client) FindChangePasswordUserId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no change.password.user was found with criteria %v and options %v", criteria, options)
}
