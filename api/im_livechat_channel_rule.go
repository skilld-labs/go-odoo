...
func (svc *ImLivechatChannelRuleService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.ImLivechatChannelRuleModel, name)
}

func (svc *ImLivechatChannelRuleService) GetByIds(ids []int64) (*types.ImLivechatChannelRules, error) {
...
func (svc *ImLivechatChannelRuleService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.ImLivechatChannelRuleModel, fields, relations)
}

func (svc *ImLivechatChannelRuleService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.ImLivechatChannelRuleModel, ids, fields, relations)
}

func (svc *ImLivechatChannelRuleService) Delete(ids []int64) error {
