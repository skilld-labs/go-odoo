...
func (svc *ProductPackagingService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.ProductPackagingModel, name)
}

func (svc *ProductPackagingService) GetByIds(ids []int64) (*types.ProductPackagings, error) {
...
func (svc *ProductPackagingService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.ProductPackagingModel, fields, relations)
}

func (svc *ProductPackagingService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.ProductPackagingModel, ids, fields, relations)
}

func (svc *ProductPackagingService) Delete(ids []int64) error {
