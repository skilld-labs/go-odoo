...
type HrLeave struct {
	...
	CanBackToApprove                *Bool      `xmlrpc:"can_back_to_approve,omitempty"`
	...
	DashboardWarningMessage         *String    `xmlrpc:"dashboard_warning_message,omitempty"`
	...
	HolidayStatusRequiresAllocation *Bool      `xmlrpc:"holiday_status_requires_allocation,omitempty"`
	...
	LeaveTypeIncreasesDuration      *String    `xmlrpc:"leave_type_increases_duration,omitempty"`
	...
	RequestDateToPeriod             *Selection `xmlrpc:"request_date_to_period,omitempty"`
