...
func (svc *ProjectConfigSettingsService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.ProjectConfigSettingsModel, name)
}

func (svc *ProjectConfigSettingsService) GetByIds(ids []int64) (*types.ProjectConfigSettingss, error) {
...
func (svc *ProjectConfigSettingsService) GetByField(field string, value string) (*types.ProjectConfigSettingss, error) {
	p := &types.ProjectConfigSettingss{}
	return p, svc.client.getByField(types.ProjectConfigSettingsModel, field, value, p)
}
...
func (svc *ProjectConfigSettingsService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.ProjectConfigSettingsModel, fields, relations)
}

func (svc *ProjectConfigSettingsService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.ProjectConfigSettingsModel, ids, fields, relations)
}

func (svc *ProjectConfigSettingsService) Delete(ids []int64) error {
