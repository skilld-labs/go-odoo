...
func (c *Client) FindAccountFiscalPositionTemplate(criteria *Criteria) (*AccountFiscalPositionTemplate, error) {
	...
	return nil, fmt.Errorf("no account.fiscal.position.template was found with criteria %v", criteria)
}
...
func (c *Client) FindAccountFiscalPositionTemplateId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no account.fiscal.position.template was found with criteria %v and options %v", criteria, options)
}
