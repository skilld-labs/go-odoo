...
func (c *Client) FindResourceCalendarLeaves(criteria *Criteria) (*ResourceCalendarLeaves, error) {
	...
	return nil, fmt.Errorf("no resource.calendar.leaves was found with criteria %v", criteria)
}
...
func (c *Client) FindResourceCalendarLeavesId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no resource.calendar.leaves was found with criteria %v and options %v", criteria, options)
}
