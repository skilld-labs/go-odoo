...
func (svc *AccountFinancialReportService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.AccountFinancialReportModel, name)
}

func (svc *AccountFinancialReportService) GetByIds(ids []int64) (*types.AccountFinancialReports, error) {
...
func (svc *AccountFinancialReportService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.AccountFinancialReportModel, fields, relations)
}

func (svc *AccountFinancialReportService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.AccountFinancialReportModel, ids, fields, relations)
}

func (svc *AccountFinancialReportService) Delete(ids []int64) error {
