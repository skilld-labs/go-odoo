...
func (svc *BaseModuleUpdateService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.BaseModuleUpdateModel, name)
}

func (svc *BaseModuleUpdateService) GetByIds(ids []int) (*types.BaseModuleUpdates, error) {
...
func (svc *BaseModuleUpdateService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.BaseModuleUpdateModel, fields, relations)
}

func (svc *BaseModuleUpdateService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.BaseModuleUpdateModel, ids, fields, relations)
}

func (svc *BaseModuleUpdateService) Delete(ids []int) error {
