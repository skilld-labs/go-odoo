...
func (c *Client) FindBaseModuleUninstall(criteria *Criteria) (*BaseModuleUninstall, error) {
	...
	return nil, fmt.Errorf("no base.module.uninstall was found with criteria %v", criteria)
}
...
func (c *Client) FindBaseModuleUninstallId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no base.module.uninstall was found with criteria %v and options %v", criteria, options)
}
