...
type DiscussChannel struct {
	...
	ChannelNameMemberIds               *Relation  `xmlrpc:"channel_name_member_ids,omitempty"`
	...
	HasCrmLead                         *Bool      `xmlrpc:"has_crm_lead,omitempty"`
	...
	LivechatAgentHistoryIds            *Relation  `xmlrpc:"livechat_agent_history_ids,omitempty"`
	LivechatAgentPartnerIds            *Relation  `xmlrpc:"livechat_agent_partner_ids,omitempty"`
	LivechatAgentProvidingHelpHistory  *Many2One  `xmlrpc:"livechat_agent_providing_help_history,omitempty"`
	LivechatAgentRequestingHelpHistory *Many2One  `xmlrpc:"livechat_agent_requesting_help_history,omitempty"`
	LivechatBotHistoryIds              *Relation  `xmlrpc:"livechat_bot_history_ids,omitempty"`
	LivechatBotPartnerIds              *Relation  `xmlrpc:"livechat_bot_partner_ids,omitempty"`
	LivechatChannelId                  *Many2One  `xmlrpc:"livechat_channel_id,omitempty"`
	LivechatChannelMemberHistoryIds    *Relation  `xmlrpc:"livechat_channel_member_history_ids,omitempty"`
	LivechatConversationTagIds         *Relation  `xmlrpc:"livechat_conversation_tag_ids,omitempty"`
	LivechatCustomerGuestIds           *Relation  `xmlrpc:"livechat_customer_guest_ids,omitempty"`
	LivechatCustomerHistoryIds         *Relation  `xmlrpc:"livechat_customer_history_ids,omitempty"`
	LivechatCustomerPartnerIds         *Relation  `xmlrpc:"livechat_customer_partner_ids,omitempty"`
	LivechatEndDt                      *Time      `xmlrpc:"livechat_end_dt,omitempty"`
	LivechatExpertiseIds               *Relation  `xmlrpc:"livechat_expertise_ids,omitempty"`
	LivechatFailure                    *Selection `xmlrpc:"livechat_failure,omitempty"`
	LivechatIsEscalated                *Bool      `xmlrpc:"livechat_is_escalated,omitempty"`
	LivechatLangId                     *Many2One  `xmlrpc:"livechat_lang_id,omitempty"`
	LivechatMatchesSelfExpertise       *Bool      `xmlrpc:"livechat_matches_self_expertise,omitempty"`
	LivechatMatchesSelfLang            *Bool      `xmlrpc:"livechat_matches_self_lang,omitempty"`
	LivechatNote                       *String    `xmlrpc:"livechat_note,omitempty"`
	LivechatOperatorId                 *Many2One  `xmlrpc:"livechat_operator_id,omitempty"`
	LivechatOutcome                    *Selection `xmlrpc:"livechat_outcome,omitempty"`
	LivechatStartHour                  *Float     `xmlrpc:"livechat_start_hour,omitempty"`
	LivechatStatus                     *Selection `xmlrpc:"livechat_status,omitempty"`
	LivechatWeekDay                    *Selection `xmlrpc:"livechat_week_day,omitempty"`
