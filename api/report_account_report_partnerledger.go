...
func (svc *ReportAccountReportPartnerledgerService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.ReportAccountReportPartnerledgerModel, name)
}

func (svc *ReportAccountReportPartnerledgerService) GetByIds(ids []int) (*types.ReportAccountReportPartnerledgers, error) {
...
func (svc *ReportAccountReportPartnerledgerService) GetByField(field string, value string) (*types.ReportAccountReportPartnerledgers, error) {
	r := &types.ReportAccountReportPartnerledgers{}
	return r, svc.client.getByName(types.ReportAccountReportPartnerledgerModel, field, value, r)
}
...
func (svc *ReportAccountReportPartnerledgerService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.ReportAccountReportPartnerledgerModel, fields, relations)
}

func (svc *ReportAccountReportPartnerledgerService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.ReportAccountReportPartnerledgerModel, ids, fields, relations)
}

func (svc *ReportAccountReportPartnerledgerService) Delete(ids []int) error {
