...
type ImLivechatChannel struct {
	...
	BlockAssignmentDuringCall    *Bool      `xmlrpc:"block_assignment_during_call,omitempty"`
	...
	MaxSessions                  *Int       `xmlrpc:"max_sessions,omitempty"`
	MaxSessionsMode              *Selection `xmlrpc:"max_sessions_mode,omitempty"`
	Name                         *String    `xmlrpc:"name,omitempty"`
	NbrChannel                   *Int       `xmlrpc:"nbr_channel,omitempty"`
	OngoingSessionCount          *Int       `xmlrpc:"ongoing_session_count,omitempty"`
	...
	RemainingSessionCapacity     *Int       `xmlrpc:"remaining_session_capacity,omitempty"`
	ReviewLink                   *String    `xmlrpc:"review_link,omitempty"`
