...
type CrmTeam struct {
	...
	DashboardGraphGroup          string    `xmlrpc:"dashboard_graph_group"`
	DashboardGraphGroupPipeline  string    `xmlrpc:"dashboard_graph_group_pipeline"`
	DashboardGraphModel          string    `xmlrpc:"dashboard_graph_model"`
	DashboardGraphPeriod         string    `xmlrpc:"dashboard_graph_period"`
	DashboardGraphPeriodPipeline string    `xmlrpc:"dashboard_graph_period_pipeline"`
	DashboardGraphType           string    `xmlrpc:"dashboard_graph_type"`
	...
	TeamType                     string    `xmlrpc:"team_type"`
