...
func (svc *IrUiMenuService) GetIdsByName(name string) ([]int, error) {
	return svc.client.getIdsByName(types.IrUiMenuModel, name)
}

func (svc *IrUiMenuService) GetByIds(ids []int) (*types.IrUiMenus, error) {
	i := &types.IrUiMenus{}
...
func (svc *IrUiMenuService) Create(fields map[string]interface{}, relations *types.Relations) (int, error) {
	return svc.client.create(types.IrUiMenuModel, fields, relations)
}

func (svc *IrUiMenuService) Update(ids []int, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.IrUiMenuModel, ids, fields, relations)
}

func (svc *IrUiMenuService) Delete(ids []int) error {
