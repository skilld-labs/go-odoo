...
func (svc *ResCompanyLdapService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.ResCompanyLdapModel, name)
}

func (svc *ResCompanyLdapService) GetByIds(ids []int64) (*types.ResCompanyLdaps, error) {
...
func (svc *ResCompanyLdapService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.ResCompanyLdapModel, fields, relations)
}

func (svc *ResCompanyLdapService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.ResCompanyLdapModel, ids, fields, relations)
}

func (svc *ResCompanyLdapService) Delete(ids []int64) error {
