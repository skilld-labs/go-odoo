...
func (c *Client) FindMailTestSimple(criteria *Criteria) (*MailTestSimple, error) {
	...
	return nil, fmt.Errorf("no mail.test.simple was found with criteria %v", criteria)
}
...
func (c *Client) FindMailTestSimpleId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no mail.test.simple was found with criteria %v and options %v", criteria, options)
}
