...
func (c *Client) FindIrModelData(criteria *Criteria) (*IrModelData, error) {
	...
	return nil, fmt.Errorf("no ir.model.data was found with criteria %v", criteria)
}
...
func (c *Client) FindIrModelDataId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("no ir.model.data was found with criteria %v and options %v", criteria, options)
}
