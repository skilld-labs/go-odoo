...
func (svc *ProductUomCategService) GetIdsByName(name string) ([]int64, error) {
	return svc.client.getIdsByName(types.ProductUomCategModel, name)
}

func (svc *ProductUomCategService) GetByIds(ids []int64) (*types.ProductUomCategs, error) {
...
func (svc *ProductUomCategService) Create(fields map[string]interface{}, relations *types.Relations) (int64, error) {
	return svc.client.create(types.ProductUomCategModel, fields, relations)
}

func (svc *ProductUomCategService) Update(ids []int64, fields map[string]interface{}, relations *types.Relations) error {
	return svc.client.update(types.ProductUomCategModel, ids, fields, relations)
}

func (svc *ProductUomCategService) Delete(ids []int64) error {
